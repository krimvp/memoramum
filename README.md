...
This repository contains the architecture and design documentation, and a **reference implementation** that follows the design's phased rollout ([doc 07 §6](docs/07-operations.md)) — currently at **P3** (policy & promotion). The docs are normative; the code implements them.
...
make test        # integration tests incl. the P1–P3 exit criteria of doc 07 §6
